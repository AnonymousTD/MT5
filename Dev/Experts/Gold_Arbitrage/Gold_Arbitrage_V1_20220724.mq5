...
#include <Trade\Trade_Modify.mqh>
#include <Cactus_Capital_Trading\Trade_Function\Position_Count.mqh>
#include <Cactus_Capital_Trading\Trade_Function\Position_Close_All_2.mqh>
//+------------------------------------------------------------------+
//|Input parameters                                                  |
//+------------------------------------------------------------------+
...
void OnTick()
  {
   ...
   {       
      ...
      //--- Close Position
      symbol_all_position_close(product_list[0], 1, trade_comment, false);
      symbol_all_position_close(product_list[1], 1, trade_comment, false);
   ...
   {       
      ...
      //--- Close Position
      symbol_all_position_close(product_list[0], 2, trade_comment,false);
      symbol_all_position_close(product_list[1], 2, trade_comment, false);
