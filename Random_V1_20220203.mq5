...
void OnTick()
  {
      ...
      //if( (Allow_Send_Order) && (position_condition) )
      
         {
            ...
            trade_request.sl = NormalizeDouble(last_tick.ask - SL_pip*_Point,_Digits);                // Stop Loss
            trade_request.tp = NormalizeDouble(last_tick.ask + (SL_pip*RR_Ratio)*_Point,_Digits);     // Take Profit
